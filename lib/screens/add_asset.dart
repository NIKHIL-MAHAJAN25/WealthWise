...
//
// "Add Asset" form screen for WealthWise — wired up to AssetProvider.
//
// pubspec.yaml:
//   dependencies:
...
import '../screens/asset_type_ui.dart'; // shared color/icon/label source of truth
...
class _AddAssetScreenState extends State<AddAssetScreen> {
  ...
  Future<void> _handleSave() async {
    ...
    final asset = Asset(
      id: null, // auto-incremented by sqflite on insert
      name: name,
      type: selectedType,
            ...
            children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(fontSize: 14.5, color: textGrey, height: 1.4),
                        ),
                      ],
                    ),
                  ),
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.calendar_today_outlined, size: 18, color: darkGreen),
                                const SizedBox(width: 10),
                                Expanded(
                                  child: Text(_formatDate(purchaseDate), style: const TextStyle(fontSize: 14.5)),
                                ),
                                Icon(Icons.keyboard_arrow_down, color: textGrey, size: 20),
                              ],
                            ),
                          ),
                        ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Based on current and purchase value', style: TextStyle(fontSize: 12, color: textGrey)),
                        ],
                      ),
                    ),
                  ],
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: Text(
                    'Cancel',
                    style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: darkGreen),
                  ),
                ),
              ),
            ],
            ...
            child: Stack(
              ...
              children: [
                Column(
                  ...
                  children: [
                    // color/icon/label now come from the shared
                    // AssetTypeUI extension — same values the
                    // Dashboard and Portfolio screens use.
